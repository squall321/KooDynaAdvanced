...
## ~~🔴 CRITICAL (P0)~~ ✅ 수정 완료 — 시뮬레이션 정합성 복구됨

### P0-1. ✅ `*DEFINE_FUNCTION` 5001 (내부단락) 함수 시그니처 — 수정 완료
...
### P0-2. ✅ `*DEFINE_FUNCTION` 5002 (발열반응) 함수 시그니처 — 수정 완료
...
### P0-3. ✅ EM_MAT_001 — 전극 Material Type — 수정 완료
...
### P0-4. ✅ `*EM_ISOPOTENTIAL` / `*EM_ISOPOTENTIAL_CONNECT` — 수정 완료
...
## ~~🟠 HIGH (P1)~~ ✅ 수정 완료 — 물리 정확도 향상됨

### P1-1. ✅ SOC/온도 의존 회로 파라미터 — 수정 완료
...
### P1-2. ✅ CC Material Type — mtype=2로 수정 완료
...
### P1-3. ✅ `*EM_RANDLES_SHORT` — return -1.0으로 수정 완료
...
## ~~🟡 MEDIUM (P2)~~ ✅ 수정 완료 — 기능 확장됨

### P2-1. ✅ `*DEFINE_FUNCTION_TABULATED` — 추가 완료
...
### P2-5. ✅ `*EM_CONTROL_EROSION` 카드 형식 — 수정 완료
...
## ~~🔵 LOW (P3)~~ ✅ 수정 완료 — 고급 기능 추가됨

### P3-1. ✅ Implicit Dynamics 옵션 — 추가 완료
...
### P3-3. ✅ `*EM_RANDLES_SHORT_ID` — 추가 완료
...
### P3-4. ✅ `*EM_ISOPOTENTIAL` randType 옵션 — 적용 완료
...
### Phase A: Critical Fixes (P0) — ✅ 완료

| # | 작업 | 파일 | 상태 |
| --- | ------ | ------ | ------ |
| A1 | DEFINE_FUNCTION 5001 시그니처 교체 (20인수) | `10_define_curves.k` | ✅ |
| A2 | DEFINE_FUNCTION 5002 시그니처 교체 (10인수 확장판) | `10_define_curves.k` | ✅ |
| A3 | 전극 EM_MAT_001 mtype 4→1 변경 (MID 3,4) | `04_materials.k` | ✅ |
| A4 | short_resistance return 0.0 → -1.0 수정 | `10_define_curves.k` | ✅ |
| A5 | EM_ISOPOTENTIAL + CONNECT 추가 | `08_em_randles*.k` | ✅ |
| A6 | 탭 NODE SET 정의 | `02_mesh*.k`, `03_mesh*.k` | ✅ |

### Phase B: Physics Accuracy (P1) — ✅ 완료

| # | 작업 | 파일 | 상태 |
| --- | ------ | ------ | ------ |
| B1 | DEFINE_TABLE 기반 R0/R1/C1 (SOC×T) | `10_define_curves.k` | ✅ |
| B2 | EM_RANDLES_SOLID 카드에 TABLE ID 반영 | `08_em_randles*.k` | ✅ |
| B3 | CC mtype 4→2 변경 | `04_materials.k` | ✅ |
| B4 | EM_CIRCUIT 통일/정리 | `08_em_randles*.k` | ✅ |
| B5 | YAML 스키마에 TABLE 파라미터 추가 | `battery_config.yaml` | ✅ |

### Phase C: Feature Enhancement (P2) — ✅ 완료

| # | 작업 | 파일 | 상태 |
| --- | ------ | ------ | ------ |
| C1 | DEFINE_FUNCTION_TABULATED 추가 (separator thickness→R) | `10_define_curves.k` | ✅ |
| C2 | SOC Shift 지원 (useSocS, tauSocS, sicslcid) | `08_em_randles*.k` | ✅ |
| C3 | BatMac 모델 파일 신규 생성 | `08_em_randles_batmac.k` | ✅ |
| C4 | TShell 모델 파일 신규 생성 | `08_em_randles_tshell.k` | ✅ |

### Phase D: Advanced (P3) — ✅ 완료

| # | 작업 | 파일 | 상태 |
| --- | ------ | ------ | ------ |
| D1 | Implicit dynamics 옵션 추가 | `07_control_phase2.k` | ✅ |
| D2 | Mortar contact 대안 | `05_contacts_mortar.k` | ✅ |
| D3 | EM_RANDLES_SHORT_ID 지원 | `08_em_randles*.k` | ✅ |
| D4 | randType 기반 ISOPOTENTIAL 활용 | `08_em_randles*.k` | ✅ |
...
> 이들은 모두 물리적으로 우수한 접근이며, P0~P3 수정이 완료되어 올바르게 작동합니다.
